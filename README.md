...
1. Get "stackbit-deploy (Read+Write)" API token from your [Sanity management console](https://manage.sanity.io/projects/emz7zctv/settings/api)
...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/sanity-pull --ssg gatsby --sanity-project-id emz7zctv --sanity-token $SANITY_ACCESS_TOKEN
...
To start editing your site, you can use the Sanity interface at https://amazing-pine-bf0eb.sanity.studio/.
...
Generated at `2021-05-24T18:32:41.797Z` by Stackbit version `0.3.52`.